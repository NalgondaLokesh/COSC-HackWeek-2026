...
- **GitHub Actions Workflow**: The configuration file is located at `.github/workflows/ci.yml`.

## How to trigger the pipeline
The pipeline is already set up! Simply push any change to this repository and then go to the **Actions** tab on your GitHub repository page to see the pipeline running automatically in real-time.
